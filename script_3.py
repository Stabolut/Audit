...
staking_contract = '''// SPDX-License-Identifier: MIT
...
with open('StakingContract.sol', 'w') as f:
    f.write(staking_contract)

print("✅ Staking Contract created successfully")
print("📄 Contract features:")
print("  - Multiple staking pools support")
print("  - MasterChef-style reward distribution")
print("  - Deposit fees and withdrawal penalties")
print("  - Emergency withdrawal functionality")
print("  - Bonus multiplier periods")
print("  - Minimum staking periods")
print("  - Pool management functions")
print("  - Reward claiming system")